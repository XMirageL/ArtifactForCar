package com.hngy.rjxh.artifactforcar.rewrite;
...
//              mTitlePaint);
        ...
        SweepGradient sweepGradient = new SweepGradient(mWheelRect.centerX(), mWheelRect.centerY(),
                new int[]{
                        Color.rgb(42, 255, 0),Color.rgb(0, 255, 0),Color.rgb(255, 0, 0),Color.rgb(255, 84, 0),Color.rgb(255, 210, 0),
                        Color.rgb(210, 255, 0),Color.rgb(168, 255, 0),Color.rgb(126, 255, 0),
                        Color.rgb(84, 255, 0)
                }, null);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCircleStrokeWidth = getTextScale(45, min);// 圆弧的宽度
        ...
        mStepPaint.setTextSize(getTextScale(200, min));  //分数大小
        mTargetPaint.setTextSize(getTextScale(50, min));
        mTitleY = getTextScale(170, min);
        mStepY = getTextScale(290, min);    //分数垂直高度 增下减上
        mTargetY = getTextScale(350, min);
